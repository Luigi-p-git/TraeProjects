...
import { 
  ...
  Sparkles, Activity, Clock, Wallet, Bot, LogOut, User, FileText
} from 'lucide-react'
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.button
              whileHover={{ scale: 1.05, boxShadow: "0 0 25px rgba(255, 165, 0, 0.3)" }}
              whileTap={{ scale: 0.95 }}
              onClick={() => setIsInvoiceUploadOpen(true)}
              className="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-xl transition-all shadow-lg hover:shadow-orange-500/25 neon-glow"
            >
      ...
      <InvoiceUploadModal
        ...
        onSubscriptionsExtracted={addMultipleSubscriptions}
      />
    </div>
  )
}